...
function onMouseScroll(e){
    ...
    if(delta<0){//向下滚动
        ...
        console.log('向上滚动');
        // $(".content_2").hide(1000,'linear');
        // $(".content_1").show(1000,'linear'); 
        $(".content_1").slideDown(500,'linear');
      
        $(".content_2").slideUp(500,'linear');
        // // $(".content_1").css({"display":"flex"});
    ...
    function bannerMove(obj) {
        ...
        _that.append(
            `<div class='banner-btn'>
                <span class='banner-btn-prev'>
                     <img src="./img/left_btn.png" />
                </span>

                <span class='banner-btn-next'>
                     <img src="./img/right_btn.png" />
                </span>
                </div>`);
        if (_length < 4) {
            if (_length < 2) {
